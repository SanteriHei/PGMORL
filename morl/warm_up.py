...
def initialize_warm_up_batch(args, device):
    ...
    for weights in weights_batch:
        ...
        avg_objs, sd_objs, avg_disc_objs, sd_disc_objs = evaluation(args, sample)
        sample.objs = avg_objs
        sample.std_objs = sd_objs
        sample.disc_objs = avg_disc_objs
        sample.disc_std_objs = sd_disc_objs
